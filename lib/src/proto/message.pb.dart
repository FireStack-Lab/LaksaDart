...
class ByteArray extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('ByteArray',
      package: const $pb.PackageName('ZilliqaMessage'))
    ..a<List<int>>(1, 'data', $pb.PbFieldType.QY);

  ByteArray() : super();
  ByteArray.fromBuffer(List<int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ByteArray.fromJson(String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class ProtoTransactionCoreInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo(
    ...
    ..a<ByteArray>(4, 'senderpubkey', $pb.PbFieldType.OM, ByteArray.getDefault,
        ByteArray.create)
    ..a<ByteArray>(
        5, 'amount', $pb.PbFieldType.OM, ByteArray.getDefault, ByteArray.create)
    ..a<ByteArray>(6, 'gasprice', $pb.PbFieldType.OM, ByteArray.getDefault,
        ByteArray.create)
  ...
  ProtoTransactionCoreInfo.fromBuffer(List<int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ProtoTransactionCoreInfo.fromJson(String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ProtoTransactionCoreInfo clone() =>
      new ProtoTransactionCoreInfo()..mergeFromMessage(this);
  ...
  static $pb.PbList<ProtoTransactionCoreInfo> createRepeated() =>
      new $pb.PbList<ProtoTransactionCoreInfo>();
  static ProtoTransactionCoreInfo getDefault() =>
      _defaultInstance ??= create()..freeze();
  static ProtoTransactionCoreInfo _defaultInstance;
  static void $checkItem(ProtoTransactionCoreInfo v) {
    if (v is! ProtoTransactionCoreInfo)
...
class ProtoTransaction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('ProtoTransaction',
      package: const $pb.PackageName('ZilliqaMessage'))
    ..a<List<int>>(1, 'tranid', $pb.PbFieldType.OY)
    ..a<ProtoTransactionCoreInfo>(2, 'info', $pb.PbFieldType.OM,
        ProtoTransactionCoreInfo.getDefault, ProtoTransactionCoreInfo.create)
    ..a<ByteArray>(3, 'signature', $pb.PbFieldType.OM, ByteArray.getDefault,
        ByteArray.create);

  ProtoTransaction() : super();
  ProtoTransaction.fromBuffer(List<int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ProtoTransaction.fromJson(String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static $pb.PbList<ProtoTransaction> createRepeated() =>
      new $pb.PbList<ProtoTransaction>();
  static ProtoTransaction getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class ProtoTransactionReceipt extends $pb.GeneratedMessage {
  ...
  ProtoTransactionReceipt.fromBuffer(List<int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ProtoTransactionReceipt.fromJson(String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ProtoTransactionReceipt clone() =>
      new ProtoTransactionReceipt()..mergeFromMessage(this);
  ...
  static $pb.PbList<ProtoTransactionReceipt> createRepeated() =>
      new $pb.PbList<ProtoTransactionReceipt>();
  static ProtoTransactionReceipt getDefault() =>
      _defaultInstance ??= create()..freeze();
  static ProtoTransactionReceipt _defaultInstance;
  static void $checkItem(ProtoTransactionReceipt v) {
    if (v is! ProtoTransactionReceipt)
      $pb.checkItemFailed(v, _i.qualifiedMessageName);
  }
...
class ProtoTransactionWithReceipt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo(
      ...
      package: const $pb.PackageName('ZilliqaMessage'))
    ..a<ProtoTransaction>(1, 'transaction', $pb.PbFieldType.OM,
        ProtoTransaction.getDefault, ProtoTransaction.create)
    ..a<ProtoTransactionReceipt>(2, 'receipt', $pb.PbFieldType.OM,
        ProtoTransactionReceipt.getDefault, ProtoTransactionReceipt.create);

  ProtoTransactionWithReceipt() : super();
  ProtoTransactionWithReceipt.fromBuffer(List<int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ProtoTransactionWithReceipt.fromJson(String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ProtoTransactionWithReceipt clone() =>
      new ProtoTransactionWithReceipt()..mergeFromMessage(this);

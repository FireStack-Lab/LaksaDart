...
class ByteArray extends $pb.GeneratedMessage {
  ...
  factory ByteArray.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ByteArray.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  ByteArray copyWith(void Function(ByteArray) updates) =>
      super.copyWith((message) => updates(message as ByteArray))
          as ByteArray; // ignore: deprecated_member_use
...
class ProtoTransactionCoreInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        ...
        $pb.PbFieldType.OU3)
    ..a<$fixnum.Int64>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nonce', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'toaddr',
        $pb.PbFieldType.OY)
  ...
  factory ProtoTransactionCoreInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProtoTransactionCoreInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProtoTransactionCoreInfo clone() =>
      ProtoTransactionCoreInfo()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProtoTransactionCoreInfo copyWith(
          void Function(ProtoTransactionCoreInfo) updates) =>
      super.copyWith((message) => updates(message as ProtoTransactionCoreInfo))
          as ProtoTransactionCoreInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ProtoTransactionCoreInfo create() => ProtoTransactionCoreInfo._();
  ProtoTransactionCoreInfo createEmptyInstance() => create();
  static $pb.PbList<ProtoTransactionCoreInfo> createRepeated() =>
      $pb.PbList<ProtoTransactionCoreInfo>();
  @$core.pragma('dart2js:noInline')
  static ProtoTransactionCoreInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProtoTransactionCoreInfo>(create);
...
class ProtoTransaction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'tranid',
        $pb.PbFieldType.OY)
    ..aOM<ProtoTransactionCoreInfo>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'info',
        subBuilder: ProtoTransactionCoreInfo.create)
    ..aOM<ByteArray>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signature',
  ...
  @$pb.TagNumber(1)
  set tranid($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set info(ProtoTransactionCoreInfo v) {
    setField(2, v);
  }
...
class ProtoTransactionReceipt extends $pb.GeneratedMessage {
  ...
  factory ProtoTransactionReceipt.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProtoTransactionReceipt.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProtoTransactionReceipt clone() =>
      ProtoTransactionReceipt()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProtoTransactionReceipt copyWith(
          void Function(ProtoTransactionReceipt) updates) =>
      super.copyWith((message) => updates(message as ProtoTransactionReceipt))
          as ProtoTransactionReceipt; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ProtoTransactionReceipt create() => ProtoTransactionReceipt._();
  ProtoTransactionReceipt createEmptyInstance() => create();
  static $pb.PbList<ProtoTransactionReceipt> createRepeated() =>
      $pb.PbList<ProtoTransactionReceipt>();
  @$core.pragma('dart2js:noInline')
  static ProtoTransactionReceipt getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProtoTransactionReceipt>(create);
...
class ProtoTransactionWithReceipt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ProtoTransactionReceipt>(2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'receipt',
        subBuilder: ProtoTransactionReceipt.create);

  ProtoTransactionWithReceipt._() : super();
  factory ProtoTransactionWithReceipt() => create();
  factory ProtoTransactionWithReceipt.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ProtoTransactionWithReceipt.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ProtoTransactionWithReceipt clone() =>
      ProtoTransactionWithReceipt()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ProtoTransactionWithReceipt copyWith(
          void Function(ProtoTransactionWithReceipt) updates) =>
      super.copyWith(
              (message) => updates(message as ProtoTransactionWithReceipt))
          as ProtoTransactionWithReceipt; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ProtoTransactionWithReceipt create() =>
      ProtoTransactionWithReceipt._();
  ProtoTransactionWithReceipt createEmptyInstance() => create();
  static $pb.PbList<ProtoTransactionWithReceipt> createRepeated() =>
      $pb.PbList<ProtoTransactionWithReceipt>();
  @$core.pragma('dart2js:noInline')
  static ProtoTransactionWithReceipt getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProtoTransactionWithReceipt>(create);
  ...
  @$pb.TagNumber(2)
  set receipt(ProtoTransactionReceipt v) {
    setField(2, v);
  }
